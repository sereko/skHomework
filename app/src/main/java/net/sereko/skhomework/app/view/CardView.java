...
import net.sereko.skhomework.app.internal.Card;
import net.sereko.skhomework.app.internal.CardExpand;
import net.sereko.skhomework.app.internal.CardHeader;
import net.sereko.skhomework.app.internal.CardThumbnail;
import net.sereko.skhomework.app.internal.ViewToClickToExpand;
import net.sereko.skhomework.app.view.component.CardHeaderView;
import net.sereko.skhomework.app.view.component.CardThumbnailView;
import net.sereko.skhomework.app.view.listener.SwipeDismissViewTouchListener;
