...
* </p>
* You can attach a Popup Menu to overflowMenu with {@link #setPopupMenu(int, net.sereko.skhomework.app.internal.CardHeader.OnClickCardHeaderPopupMenuListener)}
* <pre><code>
...
* </code></pre>
* </p>
* You can attach a {@link net.sereko.skhomework.app.internal.CardHeader.OnClickCardHeaderOtherButtonListener} to button to listen any callback when
...
public class CardHeader extends BaseCard {
     ...
     * You can use a xml layout with {@link net.sereko.skhomework.app.internal.CardHeader#setInnerLayout(int)} or with constructor
     * {@link net.sereko.skhomework.app.internal.CardHeader#CardHeader(android.content.Context, int)}.
     *
